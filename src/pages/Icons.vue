  ...
  <div>
    ...
    <div>
      <card>
        ...
        <h6 class="card-subtitle mb-2 text-muted">APP ID: 102</h6>
        <p class="card-text">positive rank: 1/1024</p>
        <p class="card-text">review count rank: 3/1024</p>
        <div class="row float-right">
          <!-- <base-button round type="primary">Primary</base-button>
      <base-button round type="primary">Primary</base-button> -->
          <div class="col" style="width: 150px">
            <a href="#" class="card-link">Google Play</a>
          </div>
          <div class="col">
      ...
      <div class="row">
        ...
        <div class="col-lg-6" :class="{ 'text-right': isRTL }">
          <card>
            ...
            <h6 class="card-subtitle mb-2 text-muted">
              negative review example review for keyword button
            </h6>
            <!-- <p class="card-text">positive:</p> -->
            <blockquote class="blockquote mb-0">
              <p>
            ...
            <template slot="header">
              ...
              <base-dropdown
                        ...
                        >
                          ...
                          <li class="nav-link">
                            <a href="#/icons" class="nav-item dropdown-item"
                              >count</a
                            >
                          </li>
                          <li class="nav-link">
